 ...
 * 
 */
package com.mycompany.jaxrs.pathURImatching;
...
public class UserRestService {
	...
	public Response getUserByName(@PathParam("name") String name){
		return Response.status(200).entity("getUserByName is called, name : " + name)
				.build();
	}
	
	// URI matching using Regex
	
	@GET
	@Path("{id : \\d+}") // support digits only
