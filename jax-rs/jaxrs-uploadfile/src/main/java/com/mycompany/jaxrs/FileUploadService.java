...
public class FileUploadService {
	...
	public Response uploadFile(
			@FormParam("file") InputStream uploadInputStream,
			@FormParam("file") FormDataContentDisposition fileDetail
			){
		
		String uploadFileLocation = "/Applications/dev-sandbox/projects/tech-training/jax-rs/JAX-RS-UploadFile/" + fileDetail.getFileName();
